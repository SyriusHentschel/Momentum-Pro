      ...
      <div class="tasks-container">
        <div class="tasks-header">
          ...
          <div class="task-controls">
            ...
            <div v-if="viewMode === 'list'" class="list-controls">
...
const viewMode = ref(preferencesStore.viewMode);
...
// Handle task edit from Kanban board
const handleKanbanEdit = async ({ id, updates }) => {
  try {
    await taskStore.updateTask(id, updates);
  } catch (error) {
    console.error('Error updating task from Kanban:', error);
  }
};
